...
import org.aksw.jena_sparql_api.sparql.ext.binding.NorseBindingTerms;
    ...
    extends ReferenceFormulationViaServiceBase
{
    ...
    public Expr reference(Var itemVar, String expr) {
        return new E_Function(NorseBindingTerms.get, ExprList.create(Arrays.asList(new ExprVar(itemVar), NodeValue.makeString(expr))));
    }
}
